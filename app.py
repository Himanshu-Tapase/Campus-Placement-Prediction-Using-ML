...
def predict():
    ...
    if prediction ==0:
        return render_template('index.html', prediction_text="Candidate is Placed").format(prediction)
    else:
        return render_template('index.html', prediction_text="Candidate is not Placed").format(prediction)
